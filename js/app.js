(() => {
    ...
    function initSliders() {
        if (document.querySelector(".auctions__slider")) new swiper_core_Swiper(".auctions__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".auctions__slider-btn.swiper-button-prev",
                nextEl: ".auctions__slider-btn.swiper-button-next"
            },
            on: {}
        });
        ...
        if (document.querySelector(".collections__slider")) new swiper_core_Swiper(".collections__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".collections__slider-btn.swiper-button-prev",
                nextEl: ".collections__slider-btn.swiper-button-next"
            },
            on: {}
        });
    }
